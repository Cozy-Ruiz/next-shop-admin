...
/* harmony import */ var _services_api___WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(788);
...
function useProvideAuth() {
    ...
    const signIn = async (email, password)=>{
        ...
        const { data: access_token  } = await axios__WEBPACK_IMPORTED_MODULE_3__["default"].post(_services_api___WEBPACK_IMPORTED_MODULE_4__/* ["default"].auth.login */ .Z.auth.login, {
            email,
            password
        }, options);
        if (access_token) {
            ...
            const { data: user  } = await axios__WEBPACK_IMPORTED_MODULE_3__["default"].get(_services_api___WEBPACK_IMPORTED_MODULE_4__/* ["default"].auth.profile */ .Z.auth.profile);
            setUser(user);
        }
    };
    const logout = ()=>{
